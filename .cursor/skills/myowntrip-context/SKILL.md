...
- [x] Pantallas y flujos de app en Figma ([design-file](https://www.figma.com/design/Vf2tNMXyKAlJSV53A1v4Is/MyOwnTrip_design-file?node-id=71-2) — páginas `00`–`08`; ver `.cursor/rules/figma-app-flows.mdc`)
- [x] Home Shell (cap 1–3) + TripHeroCard + Eyebrow label en DS — ver `docs/sessions/2026-06-17-home-ds-figma.md`
